...
public class Propiedad {
	...
	public Propiedad (String unNombre, String unaDescrip, double unPrecio, String unaDire, Cancelacion unaCancelacion) {
		...
		this.politicaCancelacion = unaCancelacion;
	}
	...
	public double cancelarReserva(Reserva r, LocalDate fecha) {
		double reembolso =  this.getPoliticaCancelacion().calcularMontoAReembolsar(r, fecha);
